...
async def handle_description(message: Message):
    ...
    await message.bot.send_message(
        ...
        \n\nВопрос: Сейчас вы можете оставить комментарий или пожелание и я отправлю вашу анкету. Если нет, то просто нажмите на кнопку "Комментариев нет"🥰.\nОтвет: {get_data[4]}'
    )
